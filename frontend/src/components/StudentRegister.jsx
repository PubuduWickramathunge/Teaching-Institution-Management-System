...
function UserRegister() {
    ...
    const[grade, setFirstName] = useState("");
        ...
        <div className="login">
            <header className = "loginForm">
                <div className="form-container"  >
                    ...
                    <Typography.Title className="title" style={{color: "royalblue"}}>Create an Account</Typography.Title>
                            <Form.Item name = "firstName" label = "First Name" rules={validationRules.firstName} hasFeedback>
                                <Input className="form-input"  placeholder="Enter Your Current Grade" value={grade}
                                onChange = {(event) =>
                                {
